...
if("FALSE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/john/catkin_ws/src/vision/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/john/catkin_ws/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /home/john/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'john <john@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/john/catkin_ws/install/${idir}'.  Ask the maintainer 'john <john@todo.todo>' to fix it.")
    endif()
...
set(image_publisher_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${image_publisher_dep}_FOUND)
      find_package(${image_publisher_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${image_publisher_dep} REQUIRED ${depend_list})
  endif()
