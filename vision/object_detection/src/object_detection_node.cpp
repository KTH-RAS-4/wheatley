...
int main (int argc, char** argv)
{
    ...
    ros::Subscriber sub = nh.subscribe ("/object_detection/preprocessed", 1, preprocessed_cb);
    ...
    /** Set up markers */
    points.header.frame_id = walls.header.frame_id = "/camera_depth_optical_frame";
